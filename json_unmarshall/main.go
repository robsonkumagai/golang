...
import (
	...
	"github.com/robsonkumagai/json_unmarshall/model"
)
...
func main() {
	...
	if err != nil {
		fmt.Println("[main] Erro ao abrir a pagina do Servidor. Erro: ",
			err.Error())
		return
	}
	...
	if resposta.StatusCode == 200 {
		...
		if err != nil {
			fmt.Println("[main] Erro ao ler o conteúdo da pagina do Servidor. Erro: ",
				err.Error())
			return
		}
		fmt.Println(" ")
